#!/usr/bin/env python3
"""
mdrg-editor — inspect and edit My Dystopian Robot Girlfriend save files.
...
Usage examples:
  mdrg-editor.py scan ./Saves
  mdrg-editor.py slots ./Saves
  mdrg-editor.py inventory M20.mdrgslot
  mdrg-editor.py color M20.mdrgslot --list
  mdrg-editor.py diff A1.mdrgslot A10.mdrgslot
  mdrg-editor.py edit M20.mdrgslot
  mdrg-editor.py where
"""
...
def cmd_scan(args):
    ...
    if not directory.is_dir():
        ...
        print("       run 'mdrg-editor where' to see the directories checked,",
              file=sys.stderr)
...
def _interactive_edit(stdscr, data, path, save_root=None):
    ...
    while True:
        ...
        try:
            hdr = f" mdrg-editor edit {DASH} {path.name}{pos}{filt} "
